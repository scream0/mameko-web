  ...
  useEffect(() => {
    async function fetchDashboardData() {
      ...
      try {
        ...
        const completedOrders = orderData.filter((o: any) =>
          [
            "completed",
            "success",
            "shipping",
        ...
        const totalSpent = completedOrders.reduce(
          (sum, o: any) => sum + Number(o.gross_amount || o.totalAmount || o.amount || o.price || o.rawPrice || 0),
          0,
        );

        // Pesanan aktif/proses adalah pesanan yang sudah dibayar dan sedang dikemas
        const processing = orderData.filter((o: any) =>
          [
            "paid",
            "success",
            "processing",
          ...
          <div className={styles.recentOrdersList}>
            {loading ? (
              ...
              recentOrders.map((order) => {
                const displayId = order.order_number || order.orderId || order.id || "";
